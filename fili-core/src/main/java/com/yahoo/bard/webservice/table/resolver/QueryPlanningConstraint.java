...
public class QueryPlanningConstraint extends DataSourceConstraint {
     ...
     * Constructor.
     *
     * @param dataApiRequest  Data API request containing the constraints information
     ...
     * Constructor.
     *
     * @param tablesApiRequest  Tables API request containing the constraints information.
     */
    public QueryPlanningConstraint(TablesApiRequest tablesApiRequest) {
        super(
                tablesApiRequest.getDimensions(),
                tablesApiRequest.getFilterDimensions(),
                Collections.emptySet(),
                Collections.emptySet(),
                tablesApiRequest.getFilters()
        );
